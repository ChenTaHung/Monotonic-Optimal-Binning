...
class PAV :
    ...
    def __initGCM(self, MonoTable, sign = 'auto') -> pd.DataFrame:
        ...
        # resDF = GCM -> it is the initialized monotonic table that are grouped by and merged for monotonicity.
        ...
        # csdDF = CSD -> it is the process that how PAVA merge the monotable.
